...
def forgotpass_screen():
    ...
    btn_sub.place(relx=.41,rely=.4)

    btn_clear=Button(frm,command=clear,width=6,text="Clear",font=('arial',20,'bold'),bd=5)
